-- ============================================================
--  UI_Main.lua  |  Exvibe Music Player  (v3 fixed)
-- ============================================================
local E  = _G.Exvibe
local C  = E.COLORS
...
-- Responsive sizing  (wider + taller than before)
...
-- ============================================================
--  WAVEFORM ICON HELPER  (replaces broken ♩ emoji)
-- ============================================================
...
-- ============================================================
--  TOGGLE BUTTON  (waveform icon, NO emoji)
-- ============================================================
...
-- ============================================================
--  MAIN FRAME  (shifted down 40 px to clear Roblox chat)
-- ============================================================
...
-- Waveform inside badge (no emoji)
...
-- Pin icon: small frame with music icon (no emoji)
...
-- Hamburger button (bigger, no square bug)
...
-- Close button: use plain "X" — no rendering bug
...
local VLayout = Instance.new("UIListLayout", ScrollFrame)
...
-- Section builder
local function makeHSection(title, height, order)
...
local SongsSec,  SongsHScroll  = makeHSection("Songs",   162, 1)
local ArtistSec, ArtistHScroll = makeHSection("Artists", 142, 2)
...
local function makeSongCard(song, parent, layoutOrder)
    ...
    -- Pin indicator: colored dot frame, NO emoji
...
ProgFill.BackgroundColor3 = Color3.new(1,1,1)   -- WHITE timeline
...
--  Anchored to center of content area (not center of full bar)
--  so they don't overlap with song name
-- ============================================================
...
-- Controls spaced 60px apart, centered in content area
...
-- Right extra buttons (bigger, no broken characters)
...
UI.BtnQueue  = makeRightBtn("≡",   -100, 18)   -- queue list
UI.BtnPeople = makeRightBtn("=+",   -64, 14)   -- social / people
UI.BtnMore   = makeRightBtn("...",  -32, 14)   -- more options
